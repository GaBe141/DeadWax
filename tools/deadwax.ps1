...
switch ($Action) {
    ...
    'test' {
        ...
        foreach ($suite in @('smoke_test', 'save_store_test', 'campaign_test', 'tonearm_test', 'overture_test', 'sprite_animation_test', 'residents_test', 'economy_state_test', 'economy_test', 'scenery_test', 'lighting_test', 'attack_feel_test', 'gui_animation_test', 'map_item_test', 'gather_reward_test', 'gather_route_test', 'loft_voice_test', 'home_song_test', 'opening_cutscene_test', 'opening_audio_test', 'yard_voice_test', 'yard_audio_test', 'combo_test', 'practice_room_test', 'combo_readability_test', 'street_looper_test')) {
